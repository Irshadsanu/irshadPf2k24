...
export default function AboutMe(props:{sectionRef:React.RefObject<HTMLDivElement>})
{
    ...
    const alias = "IAMIRSHADIAMIRSHADIAMIRSHADIAMIRSHADIAMIRSHAD";
    const bday = "I0R0SI0R0SI0R0SI0R0SI0R0SI0R0SI0R0SI0R0SI0R0SI";
    ...
    return (
        <div ref={props.sectionRef} className="relative">
            <ScrollIndicator>
                <h1 className="text-xs opacity-50">Heyy guys</h1>
            </ScrollIndicator>
            ...
            <div className="md:container md:mx-auto flex flex-row items-end gap-8 px-8">
                <div className='w-full lg:w-3/4'>
                    <div className="overflow-y-clip">
                        <h1 ref={MeRef[0]} className='text-xl sm:text-5xl font-extrabold mt-1'>MHD. IRSHAD <span className='gradient-text'>ALI</span></h1>
                    </div>
                    <hr className='border-primary border-2 mt-4'/>
                    <div className="mt-4 flex flex-wrap gap-1">
                        {
                            ["Flutter Developer","React Developer","Backend","Api"].map((value,index)=>{
                    ...
                    I'm a software developer specializing in mobile app and web development, backend systems, AI feature implementation, and branding leadership. As an expert in these areas, I excel at creating innovative solutions and leading teams to success.
                    </p>
                </div>
