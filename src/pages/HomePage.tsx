    ...
    <>
        ...
        <ParallaxBG>
            <div className='flex flex-col justify-center items-center'>
                ...
                <div ref={heroTextRef[1]} className='overflow-y-clip'><h1 className='text-3xl md:text-7xl font-extrabold uppercase'><AnimatedText delay={200} text='IRSHAD'/></h1></div>
                ...
                <div ref={heroTextRef[0]} className='bg-red flex gap-5 mt-4'>
                    ...
                    <TransitionLink to='/3D'>
                        <Button color='primary' className='md:w-48'>EXPLORE 3D WEB</Button>
                    </TransitionLink>
                    <TransitionLink 
                    to='/irsh'
                    // to='/projects'
